...
[https://github.com/kohandev/map_viewer_front](https://github.com/kohandev/map_viewer_front)
...
***GET /engine/stop*** - запит на зупинку генерації гео-поінтів, та скидання "токену"
...
За запитом /engine/start створюється масив гео-поінтів.
Кількість елементів масиву є випадковою — від 100 до 200).
Гео-поінти генеруються у межах заданого периметра.
Постійно генеруються зміни в створеному масиві.
...
За запитом За запитом /geo — отримуємо стан масиву на момент запиту.
...
```bash
git clone https://github.com/kohandev/map_viewer_mock_server.git
